...
def main():
    ...
    workflow_names_str = os.environ.get('WORKFLOW_NAMES', 'Build App,Copilot coding agent,Copilot Setup Steps,Dependabot Updates,Lock Threads,Recycle Runs,Release App,Update Go Version,Update Serva Sync submodule')
