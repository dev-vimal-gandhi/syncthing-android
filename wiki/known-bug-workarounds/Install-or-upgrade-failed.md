...
- Open the Serva Sync menu -> Import & Export -> Export config
- Open the Serva Sync menu -> Exit
- Android settings -> Apps -> Serva Sync -> Force stop
- Android settings -> Apps -> Serva Sync -> Uninstall, do NOT keep data when Android asks (this refers to the app's config, not your synced folders)
- Install latest release
- Open the Serva Sync menu -> Import & Export -> Import config
