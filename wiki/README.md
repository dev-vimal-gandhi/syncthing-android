## Welcome to the Serva Sync for Android wiki!

If you are a new user, we suggest you read [Serva Sync's getting started guide](https://docs.syncthing.net/intro/getting-started.html#getting-started).
