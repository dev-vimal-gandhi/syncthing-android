package com.servalabs.sync.fragments.dialog;
...
import com.servalabs.sync.activities.FolderPickerActivity;
import com.servalabs.sync.fragments.NumberPickerFragment;
...
public class StaggeredVersioningFragment extends Fragment {
    ...
    //The maxAge parameter is displayed in days but stored in seconds since Serva Sync needs it in seconds.
