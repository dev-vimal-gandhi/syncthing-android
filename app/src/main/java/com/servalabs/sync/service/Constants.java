...
public class Constants {
    ...
    // Preferences - Serva Sync Options
    ...
    /**
     * Available options cache for preference {@link com.servalabs.sync.R.xml#app_settings#debug_facilities_enabled}
     ...
     * Serva Sync v1.3.0+ attempts to enable the NAT feature.
     */
