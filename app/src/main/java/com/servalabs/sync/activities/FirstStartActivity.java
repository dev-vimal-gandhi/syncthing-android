...
import com.servalabs.sync.service.SyncthingRunnable.ExecutableNotFoundException;
...
import com.servalabs.sync.views.CustomViewPager;
...
public class FirstStartActivity extends ThemedAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (showSlideKeyGeneration) {
            Log.d(TAG, "We (no longer?) have a valid Serva Sync config and will attempt to generate a fresh config.");
        }
